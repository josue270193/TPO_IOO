...
public class BajaCliente extends JDialog{
	...
	private void initGUI() {
		...
		alta = new JButton(Constantes.Eliminar);
		...
		alta.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				...
				JOptionPane.showMessageDialog(BajaCliente.this, Constantes.Exito_ClienteEliminado, "", JOptionPane.INFORMATION_MESSAGE);
		...
		buscar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				...
				if (controlador.existeCliente(DniCliente.getText())
					...
					JOptionPane.showMessageDialog(BajaCliente.this, Constantes.Error_NoExisteCliente, "", JOptionPane.ERROR_MESSAGE);
				}
			}
		});
